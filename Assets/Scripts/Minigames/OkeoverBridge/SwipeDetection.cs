...
public class SwipeDetection : MonoBehaviour
{
    ...
    [SerializeField] private float swipeResistance = 100; // threshold for touch to be considered a swipe, measured in pixels. //TODO: make reqd swiping length dependent on screen size
